...
const HomeHero = () => (
    <section className="w-full bg-homeHero pb-20 md:pb-28 lg:pb-36 xl:pb-44">
        ...
        <section className={`z-0 bg-transparent relative`}>
            <section className="z-[2] relative w-full pt-16 md:pt-24 lg:pt-0 p-container grid grid-cols-1 lg:grid-cols-[min(700px,_55%)_1fr] 2xl:grid-cols-[700px_1fr] gap-12 md:gap-16 lg:gap-12">
                ...
                <div className="flex justify-center lg:justify-end">
                    <img src={home.heroImg} alt="" className="translate-x-[3.625rem]" />
                </div>
            </section>
        </section>
    </section>
