...
const Nationwide = () => (
    <section className="w-full p-container pt-14 pb-32 grid gap-[4.75rem] items-center">
        <div className="max-w-max mx-auto grid gap-[1.875rem]">
            <h3 className="w-max-max text-dark-19 heading-3 font-semibold md:heading-2 text-center">
