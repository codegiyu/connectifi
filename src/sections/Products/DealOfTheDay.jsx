import cubes from "../../assets/convert-3d-cube-white.svg";
...
const DealOfTheDay = () => {
    ...
    return (
        <section className="w-full pt-[8rem] pb-[7.5rem]">
            <section className="p-container grid gap-[3.125rem]">
                <div className="w-full rounded-[40px] bg-white grid lg:grid-cols-2 items-center px-4 lg:px-[45px]">
                    <div className="w-full h-fit my-10 lg:my-5 grid gap-8">
                        <div className="w-full flex items-center justify-center lg:justify-start gap-[10px]">
                            <span className="text-[#3F3F3F] body-text-6-medium md:body-text-4">Time Left:</span>
                            <TimeBoxGroup
                        ...
                        <div className="w-full flex gap-[10px] justify-center lg:justify-start items-center text-[#3F3F3F] font-medium">
                        ...
                        <div className="w-[90%] lg:w-fit mx-auto lg:mx-0 flex items-center gap-[10px]">
                            <div className="bg-bright-blue py-[15px] px-[14px] rounded-[10px] flex-none">
                                <img src={cubes} alt="" className="w-5 h-5 md:w-6 md:h-6" />
                            </div>
                            <p className="lg:max-w-[300px] body-text-6-medium md:body-text-4 capitalize text-grey-89">
                        ...
                        <div className="w-fit mx-auto lg:mx-0 flex items-center gap-8 relative">
                            ...
                            <span className="text-[#3F3F3F] body-text-2 md:heading-3 font-bold lg:heading-2-bold">₦40,000</span>
